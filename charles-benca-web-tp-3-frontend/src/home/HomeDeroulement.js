        ...
        <div>
            <HomeNavBar />
			  ...
			  Tâches à effectuer par l'étudiant à la session d'automne  (c'est-à-dire maintenant):
				...
				Pour chaque employeur que vous contactez vous devez inscrire ses coordonnées sur le formulaire <a href="../documents/contact_employeurs.pdf" />
			 ...
			 Lisez ce document concernant 
			      <a href="../documents/Code_ethique_presentation_stages.pdf" />l'éthique et les dates (pour Hiver 2019)
...
export default HomeDeroulement;
